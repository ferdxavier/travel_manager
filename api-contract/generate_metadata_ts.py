...
# 2. Diretório RAIZ de ESCRITA (onde os modelos TS e metadados serão salvos)
# Este é o diretório 'models'
...
def process_all_yaml_files():
    ...
    for file_name in files_to_process:
        ...
        # REMOVIDO: Remoção da lógica de subdiretório. Os arquivos TS de metadados
        # agora vão diretamente para o diretório TS_OUTPUT_ROOT_DIR (models/).
        ts_output_path = os.path.join(TS_OUTPUT_ROOT_DIR, f"{base_name}_structured_docs.ts")
...
"""
            ...
            # CORREÇÃO CRÍTICA: O export agora é direto para o arquivo, pois ele está no mesmo nível do index.ts
            exports_list.append(f"./{base_name}_structured_docs")
