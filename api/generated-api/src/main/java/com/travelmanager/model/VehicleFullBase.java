...
@Schema(name = "VehicleFullBase", description = "Propriedades de base e comuns do Veículo.")
...
public class VehicleFullBase {
  ...
  public VehicleFullBase id(@Nullable UUID id) {
    this.id = id;
    return this;
  }
  ...
  public VehicleFullBase createdAt(@Nullable OffsetDateTime createdAt) {
  ...
  public VehicleFullBase licensePlate(@Nullable String licensePlate) {
  ...
  public VehicleFullBase model(@Nullable String model) {
    this.model = model;
    return this;
  }
  ...
  public VehicleFullBase vehicleManufacturer(@Nullable String vehicleManufacturer) {
  ...
  public VehicleFullBase modelYear(@Nullable Integer modelYear) {
  ...
  public VehicleFullBase manufacturerYear(@Nullable Integer manufacturerYear) {
  ...
  public VehicleFullBase renavan(@Nullable String renavan) {
  ...
  public VehicleFullBase passengerNumber(@Nullable Integer passengerNumber) {
  ...
  public VehicleFullBase motorNumber(@Nullable String motorNumber) {
  ...
  public VehicleFullBase chassisNumber(@Nullable String chassisNumber) {
  ...
  public VehicleFullBase fleetNumber(@Nullable Integer fleetNumber) {
  ...
  public VehicleFullBase fuelTankCapacity(@Nullable Float fuelTankCapacity) {
  ...
  public VehicleFullBase entryMileage(@Nullable Integer entryMileage) {
  ...
  public VehicleFullBase averageConsumption(@Nullable Float averageConsumption) {
  ...
  public VehicleFullBase bodyManufacturer(@Nullable String bodyManufacturer) {
  ...
  public VehicleFullBase bodyModel(@Nullable String bodyModel) {
  ...
  public VehicleFullBase axesNumber(@Nullable Integer axesNumber) {
  ...
  public VehicleFullBase engineDescription(@Nullable String engineDescription) {
  ...
  public VehicleFullBase hasBathroom(@Nullable Boolean hasBathroom) {
  ...
  public VehicleFullBase status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    VehicleFullBase vehicleFullBase = (VehicleFullBase) o;
    return Objects.equals(this.id, vehicleFullBase.id) &&
        Objects.equals(this.createdAt, vehicleFullBase.createdAt) &&
        Objects.equals(this.licensePlate, vehicleFullBase.licensePlate) &&
        Objects.equals(this.model, vehicleFullBase.model) &&
        Objects.equals(this.vehicleManufacturer, vehicleFullBase.vehicleManufacturer) &&
        Objects.equals(this.modelYear, vehicleFullBase.modelYear) &&
        Objects.equals(this.manufacturerYear, vehicleFullBase.manufacturerYear) &&
        Objects.equals(this.renavan, vehicleFullBase.renavan) &&
        Objects.equals(this.passengerNumber, vehicleFullBase.passengerNumber) &&
        Objects.equals(this.motorNumber, vehicleFullBase.motorNumber) &&
        Objects.equals(this.chassisNumber, vehicleFullBase.chassisNumber) &&
        Objects.equals(this.fleetNumber, vehicleFullBase.fleetNumber) &&
        Objects.equals(this.fuelTankCapacity, vehicleFullBase.fuelTankCapacity) &&
        Objects.equals(this.entryMileage, vehicleFullBase.entryMileage) &&
        Objects.equals(this.averageConsumption, vehicleFullBase.averageConsumption) &&
        Objects.equals(this.bodyManufacturer, vehicleFullBase.bodyManufacturer) &&
        Objects.equals(this.bodyModel, vehicleFullBase.bodyModel) &&
        Objects.equals(this.axesNumber, vehicleFullBase.axesNumber) &&
        Objects.equals(this.engineDescription, vehicleFullBase.engineDescription) &&
        Objects.equals(this.hasBathroom, vehicleFullBase.hasBathroom) &&
        Objects.equals(this.status, vehicleFullBase.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, createdAt, licensePlate, model, vehicleManufacturer, modelYear, manufacturerYear, renavan, passengerNumber, motorNumber, chassisNumber, fleetNumber, fuelTankCapacity, entryMileage, averageConsumption, bodyManufacturer, bodyModel, axesNumber, engineDescription, hasBathroom, status);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VehicleFullBase {\n");
