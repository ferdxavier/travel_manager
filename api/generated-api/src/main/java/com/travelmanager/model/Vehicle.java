...
@Schema(name = "Vehicle", description = "Representação completa de um veículo na frota.")
...
public class Vehicle {
   ...
   */
  public Vehicle(UUID id, String licensePlate, String model, StatusEnum status) {
    this.id = id;
   ...
   */
  @NotNull @Valid 
  @Schema(name = "id", example = "a1b2c3d4-e5f6-7890-1234-567890abcdef", description = "ID único gerado pelo sistema.", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("id")
  public UUID getId() {
    return id;
  }
  ...
  public Vehicle createdAt(@Nullable OffsetDateTime createdAt) {
  ...
  public Vehicle vehicleManufacturer(@Nullable String vehicleManufacturer) {
  ...
  public Vehicle modelYear(@Nullable Integer modelYear) {
  ...
  public Vehicle manufacturerYear(@Nullable Integer manufacturerYear) {
  ...
  public Vehicle renavan(@Nullable String renavan) {
  ...
  public Vehicle passengerNumber(@Nullable Integer passengerNumber) {
  ...
  public Vehicle motorNumber(@Nullable String motorNumber) {
  ...
  public Vehicle chassisNumber(@Nullable String chassisNumber) {
  ...
  public Vehicle fleetNumber(@Nullable Integer fleetNumber) {
  ...
  public Vehicle fuelTankCapacity(@Nullable Float fuelTankCapacity) {
  ...
  public Vehicle entryMileage(@Nullable Integer entryMileage) {
  ...
  public Vehicle averageConsumption(@Nullable Float averageConsumption) {
  ...
  public Vehicle bodyManufacturer(@Nullable String bodyManufacturer) {
  ...
  public Vehicle bodyModel(@Nullable String bodyModel) {
  ...
  public Vehicle axesNumber(@Nullable Integer axesNumber) {
  ...
  public Vehicle engineDescription(@Nullable String engineDescription) {
  ...
  public Vehicle hasBathroom(@Nullable Boolean hasBathroom) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, vehicle.id) &&
        ...
        Objects.equals(this.manufacturerYear, vehicle.manufacturerYear) &&
        Objects.equals(this.renavan, vehicle.renavan) &&
        Objects.equals(this.passengerNumber, vehicle.passengerNumber) &&
        Objects.equals(this.motorNumber, vehicle.motorNumber) &&
        Objects.equals(this.chassisNumber, vehicle.chassisNumber) &&
        Objects.equals(this.fleetNumber, vehicle.fleetNumber) &&
        Objects.equals(this.fuelTankCapacity, vehicle.fuelTankCapacity) &&
        Objects.equals(this.entryMileage, vehicle.entryMileage) &&
        Objects.equals(this.averageConsumption, vehicle.averageConsumption) &&
        Objects.equals(this.bodyManufacturer, vehicle.bodyManufacturer) &&
        Objects.equals(this.bodyModel, vehicle.bodyModel) &&
        Objects.equals(this.axesNumber, vehicle.axesNumber) &&
        Objects.equals(this.engineDescription, vehicle.engineDescription) &&
        Objects.equals(this.hasBathroom, vehicle.hasBathroom) &&
