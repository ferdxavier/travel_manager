...
@Schema(name = "CreateVehicleRequest", description = "Dados necessários para criar um veículo (sem o ID gerado pelo sistema e timestamps).")
...
public class CreateVehicleRequest {
   ...
   */
  public CreateVehicleRequest(String licensePlate, String model, String vehicleManufacturer, Integer modelYear, Integer manufacturerYear, Integer passengerNumber, String chassisNumber, Boolean hasBathroom, StatusEnum status) {
  ...
  public CreateVehicleRequest licensePlate(String licensePlate) {
    this.licensePlate = licensePlate;
    return this;
  }
   ...
   * @return licensePlate
   */
  @NotNull @Pattern(regexp = "^[a-zA-Z]{3}[0-9][a-zA-Z][0-9]{2}$") @Size(min = 7, max = 7) 
  @Schema(name = "licensePlate", example = "ABC1F34", description = "Placa do veículo. Formato Mercosul (LLLNLNN).", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  public CreateVehicleRequest model(String model) {
    this.model = model;
    return this;
  }
  ...
  @Schema(name = "model", example = "520 HP", description = "Modelo e nome do veículo.", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("model")
  ...
  public CreateVehicleRequest vehicleManufacturer(String vehicleManufacturer) {
    this.vehicleManufacturer = vehicleManufacturer;
    return this;
  }
   ...
   */
  @NotNull @Size(min = 2, max = 20) 
  @Schema(name = "vehicleManufacturer", example = "Scania", description = "Fabricante do veículo.", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  public CreateVehicleRequest modelYear(Integer modelYear) {
    this.modelYear = modelYear;
    return this;
  }
   ...
   * @return modelYear
   */
  @NotNull @Min(value = 1980) @Max(value = 2099) 
  @Schema(name = "modelYear", example = "2024", description = "Ano do Modelo do veículo.", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  public CreateVehicleRequest manufacturerYear(Integer manufacturerYear) {
    this.manufacturerYear = manufacturerYear;
    return this;
  }
   ...
   */
  @NotNull @Min(value = 1980) @Max(value = 2099) 
  @Schema(name = "manufacturerYear", example = "2023", description = "Ano de fabricação do veículo.", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  public CreateVehicleRequest renavan(@Nullable String renavan) {
  ...
  public CreateVehicleRequest passengerNumber(Integer passengerNumber) {
    this.passengerNumber = passengerNumber;
    return this;
  }
   ...
   */
  @NotNull @Min(value = 1) @Max(value = 80) 
  @Schema(name = "passengerNumber", example = "50", description = "Em caso de veículo de transporte, o número de passageiros.", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  public CreateVehicleRequest motorNumber(@Nullable String motorNumber) {
  ...
  public CreateVehicleRequest chassisNumber(String chassisNumber) {
    this.chassisNumber = chassisNumber;
    return this;
  }
  ...
  @Schema(name = "chassisNumber", example = "BDH546SDFG565465SD5656BR", description = "Número do chassis do veículo.", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  public CreateVehicleRequest fleetNumber(@Nullable Integer fleetNumber) {
  ...
  public CreateVehicleRequest fuelTankCapacity(@Nullable Float fuelTankCapacity) {
  ...
  public CreateVehicleRequest entryMileage(@Nullable Integer entryMileage) {
  ...
  public CreateVehicleRequest averageConsumption(@Nullable Float averageConsumption) {
  ...
  public CreateVehicleRequest bodyManufacturer(@Nullable String bodyManufacturer) {
  ...
  public CreateVehicleRequest bodyModel(@Nullable String bodyModel) {
  ...
  public CreateVehicleRequest axesNumber(@Nullable Integer axesNumber) {
  ...
  public CreateVehicleRequest engineDescription(@Nullable String engineDescription) {
  ...
  public CreateVehicleRequest hasBathroom(Boolean hasBathroom) {
    this.hasBathroom = hasBathroom;
    return this;
  }
   ...
   */
  @NotNull 
  @Schema(name = "hasBathroom", example = "true", description = "Se o veículo possui banheiro", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  public CreateVehicleRequest status(StatusEnum status) {
    this.status = status;
    return this;
  }
   ...
   */
  @NotNull 
  @Schema(name = "status", description = "Status operacional atual/desejado do veículo.", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("status")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.licensePlate, createVehicleRequest.licensePlate) &&
        Objects.equals(this.model, createVehicleRequest.model) &&
        Objects.equals(this.vehicleManufacturer, createVehicleRequest.vehicleManufacturer) &&
        Objects.equals(this.modelYear, createVehicleRequest.modelYear) &&
        Objects.equals(this.manufacturerYear, createVehicleRequest.manufacturerYear) &&
        Objects.equals(this.renavan, createVehicleRequest.renavan) &&
        Objects.equals(this.passengerNumber, createVehicleRequest.passengerNumber) &&
        Objects.equals(this.motorNumber, createVehicleRequest.motorNumber) &&
        Objects.equals(this.chassisNumber, createVehicleRequest.chassisNumber) &&
        Objects.equals(this.fleetNumber, createVehicleRequest.fleetNumber) &&
        Objects.equals(this.fuelTankCapacity, createVehicleRequest.fuelTankCapacity) &&
        Objects.equals(this.entryMileage, createVehicleRequest.entryMileage) &&
        Objects.equals(this.averageConsumption, createVehicleRequest.averageConsumption) &&
        Objects.equals(this.bodyManufacturer, createVehicleRequest.bodyManufacturer) &&
        Objects.equals(this.bodyModel, createVehicleRequest.bodyModel) &&
        Objects.equals(this.axesNumber, createVehicleRequest.axesNumber) &&
        Objects.equals(this.engineDescription, createVehicleRequest.engineDescription) &&
        Objects.equals(this.hasBathroom, createVehicleRequest.hasBathroom) &&
        Objects.equals(this.status, createVehicleRequest.status);
  }
