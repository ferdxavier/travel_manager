...
@Schema(name = "UpdateVehicleRequest", description = "Dados opcionais necessários para atualizar parcialmente um veículo existente (suporte a PATCH). Pelo menos um campo deve ser fornecido.")
...
public class UpdateVehicleRequest {
  ...
  public UpdateVehicleRequest licensePlate(@Nullable String licensePlate) {
  ...
  public UpdateVehicleRequest model(@Nullable String model) {
    this.model = model;
    return this;
  }
  ...
  public UpdateVehicleRequest vehicleManufacturer(@Nullable String vehicleManufacturer) {
  ...
  public UpdateVehicleRequest modelYear(@Nullable Integer modelYear) {
  ...
  public UpdateVehicleRequest manufacturerYear(@Nullable Integer manufacturerYear) {
  ...
  public UpdateVehicleRequest renavan(@Nullable String renavan) {
  ...
  public UpdateVehicleRequest passengerNumber(@Nullable Integer passengerNumber) {
  ...
  public UpdateVehicleRequest motorNumber(@Nullable String motorNumber) {
  ...
  public UpdateVehicleRequest chassisNumber(@Nullable String chassisNumber) {
  ...
  public UpdateVehicleRequest fleetNumber(@Nullable Integer fleetNumber) {
  ...
  public UpdateVehicleRequest fuelTankCapacity(@Nullable Float fuelTankCapacity) {
  ...
  public UpdateVehicleRequest entryMileage(@Nullable Integer entryMileage) {
  ...
  public UpdateVehicleRequest averageConsumption(@Nullable Float averageConsumption) {
  ...
  public UpdateVehicleRequest bodyManufacturer(@Nullable String bodyManufacturer) {
  ...
  public UpdateVehicleRequest bodyModel(@Nullable String bodyModel) {
  ...
  public UpdateVehicleRequest axesNumber(@Nullable Integer axesNumber) {
  ...
  public UpdateVehicleRequest engineDescription(@Nullable String engineDescription) {
  ...
  public UpdateVehicleRequest hasBathroom(@Nullable Boolean hasBathroom) {
  ...
  public UpdateVehicleRequest status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.licensePlate, updateVehicleRequest.licensePlate) &&
        Objects.equals(this.model, updateVehicleRequest.model) &&
        Objects.equals(this.vehicleManufacturer, updateVehicleRequest.vehicleManufacturer) &&
        Objects.equals(this.modelYear, updateVehicleRequest.modelYear) &&
        Objects.equals(this.manufacturerYear, updateVehicleRequest.manufacturerYear) &&
        Objects.equals(this.renavan, updateVehicleRequest.renavan) &&
        Objects.equals(this.passengerNumber, updateVehicleRequest.passengerNumber) &&
        Objects.equals(this.motorNumber, updateVehicleRequest.motorNumber) &&
        Objects.equals(this.chassisNumber, updateVehicleRequest.chassisNumber) &&
        Objects.equals(this.fleetNumber, updateVehicleRequest.fleetNumber) &&
        Objects.equals(this.fuelTankCapacity, updateVehicleRequest.fuelTankCapacity) &&
        Objects.equals(this.entryMileage, updateVehicleRequest.entryMileage) &&
        Objects.equals(this.averageConsumption, updateVehicleRequest.averageConsumption) &&
        Objects.equals(this.bodyManufacturer, updateVehicleRequest.bodyManufacturer) &&
        Objects.equals(this.bodyModel, updateVehicleRequest.bodyModel) &&
        Objects.equals(this.axesNumber, updateVehicleRequest.axesNumber) &&
        Objects.equals(this.engineDescription, updateVehicleRequest.engineDescription) &&
        Objects.equals(this.hasBathroom, updateVehicleRequest.hasBathroom) &&
        Objects.equals(this.status, updateVehicleRequest.status);
  }
